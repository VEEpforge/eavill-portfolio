    ...
    <section id='about' className='flex flex-col items-start justify-center min-h-screen p-[3vw] text-zinc-950'>
      ...
      <div className='flex flex-col lg:flex-row'>
        ...
        <div className='flex-col space-y-8 m-[2vw]'>
          <p className='font-cabinetgrotesk font-medium text-zinc-950 text-3xl lg:text-[3vw] text-justify lg:leading-12'>I approach things with a distinct blend of fun and minimalism, seamlessly navigating challenges and delivering <span className='italic text-blue-800'>creative</span> and <span className='italic text-blue-800'>functional</span> solutions.
          </p>
          <p className='font-satoshi text-2xl lg:text-[1.25vw] text-justify'>
